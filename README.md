...
1. `dist` klasöründeki **`MailLoader Setup 1.0.2.exe`** dosyasına çift tıklayın bulamazsanız direkt ** https://drive.google.com/file/d/1rEfdZyMVjf-97YZ9NsY8797N3eNednxs/view?usp=sharing ** linki ile indirebilirsiniz. 
